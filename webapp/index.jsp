                    ...
                    <c:choose>
                        <c:when test="${status.first}">
                            <div class="item active">
                                <h2 class="hdng"><a href="http://119.91.22.246:8080/McDonalds/goods/goodsDetail?id=${g.id}">${g.name}</a><span></span></h2>
                                <p>今日精选推荐</p>
                ...
                <div class="col-md-4 gallery-grid glry-two">
                    ...
                    <div class="gallery-info galrr-info-two">
                        <p>
                            ...
                            <a href="http://119.91.22.246:8080/McDonalds/goods/goodsDetail?id=${g.id}">查看详情</a>
                        </p>
